from .views import (
    ...
    DeleteTaskTypesView,
    TaskDeleteView,
    ProjectDeleteView, ManualWorkerRegisterView, WorkerCreatedView, create_position, delete_positions,
    delete_own_account
)
...
urlpatterns = [
    ...
    path("positions/create/", create_position, name="create_position"),
    path("positions/delete/", delete_positions, name="delete_positions"),
    ...
    path('manual-register/', ManualWorkerRegisterView.as_view(), name='manual_register'),
    path('manual-register/worker_created/', WorkerCreatedView.as_view(), name='worker_created'),
